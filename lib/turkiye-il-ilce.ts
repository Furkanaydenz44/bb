// Türkiye'nin 81 ili ve ilçeleri. İl adları Türkçe alfabetik sırada.
// İlan Aç formundaki kademeli (il → ilçe) konum seçimi bu veriden beslenir.

export const ilIlce: Record<string, string[]> = {
...
// İl adları (dropdown için) — nesne anahtar sırası korunur.
export const ilAdlari: string[] = Object.keys(ilIlce);

// Verilen ilin ilçelerini döndürür (yoksa boş dizi).
