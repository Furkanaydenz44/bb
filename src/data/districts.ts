// İl/ilçe verisi — Resmî "İlçeler Genel Listesi" (İçişleri Bakanlığı, İller İdaresi).
// 81 il, 922 ilçe. Anahtarlar CreateDemandPage CITIES ile birebir.
export const districtsByCity: Record<string, string[]> = {
  ...
  'Hakkâri': ['Çukurca', 'Derecik', 'Şemdinli', 'Yüksekova'],
  'Hatay': ['Altınözü', 'Antakya', 'Arsuz', 'Belen', 'Defne', 'Dörtyol', 'Erzin', 'Hassa', 'İskenderun', 'Kırıkhan', 'Kumlu', 'Payas', 'Reyhanlı', 'Samandağ', 'Yayladağı'],
  'Iğdır': ['Aralık', 'Karakoyunlu', 'Tuzluca'],
  'Isparta': ['Aksu', 'Atabey', 'Eğirdir', 'Gelendost', 'Gönen', 'Keçiborlu', 'Senirkent', 'Sütçüler', 'Şarkikaraağaç', 'Uluborlu', 'Yalvaç', 'Yenişarbademli'],
